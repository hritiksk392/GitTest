...
char ch,word[20],kw[20000][20]={"int","float","if","else","for","while","break","string","return","main"};
char Delimeters[]="{}()[];";
string wordy ="";
unordered_set <string> kw =  {"int","float","if","else","for","while","break","string","return","main"};
int32_t main(){
  FILE *f;
  f=fopen("input.txt","r");
  bool exit=false;
